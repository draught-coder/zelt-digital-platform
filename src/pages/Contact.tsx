        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            {contactMethods.map((method, index) => (
              <div key={index} className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-200 border border-gray-200 text-center">
                ...
                <a
                  ...
                  className={`${method.color} text-white px-6 py-3 rounded-full font-medium transition-all duration-200 inline-block shadow-lg`}
                >
                  {method.action}
                </a>
              </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto">
            ...
            <form className="bg-gray-50 p-8 rounded-2xl shadow-lg border border-gray-200">
