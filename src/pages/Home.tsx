  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                to="/products"
                className="bg-gradient-to-r from-blue-500 to-blue-700 text-white px-8 py-4 rounded-full text-lg font-medium hover:from-blue-600 hover:to-blue-800 transition-all duration-200 transform hover:scale-105 flex items-center justify-center space-x-2"
              >
              ...
              <a
                ...
                className="border-2 border-blue-500 text-blue-400 px-8 py-4 rounded-full text-lg font-medium hover:bg-blue-500 hover:text-white transition-all duration-200"
              >
                WhatsApp Us Now
              </a>
            </div>
      ...
      <section className="py-20 bg-slate-900">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-white mb-4">Why Choose Ibn Zelt?</h2>
            <p className="text-xl text-gray-400">Experience the future of bookkeeping with our cutting-edge technology</p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <div key={index} className="bg-slate-800 p-8 rounded-2xl border border-blue-500/20 hover:border-blue-500/40 transition-all duration-200 transform hover:scale-105">
      ...
      <section className="py-20 bg-gradient-to-br from-slate-950 to-blue-950">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-white mb-4">Cloud ERP Pricing</h2>
            <p className="text-xl text-gray-400">Choose the perfect plan for your business needs</p>
          </div>
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {pricingTiers.map((tier, index) => (
              <div key={index} className={`bg-slate-800 p-8 rounded-2xl border ${index === 1 ? 'border-blue-500 scale-105' : 'border-blue-500/20'} relative`}>
                {index === 1 && (
                ...
                <div className="mb-6">
                  <span className="text-4xl font-bold text-blue-400">RM{tier.price}</span>
                ...
                <Link
                  to="/contact"
                  className={`w-full py-3 rounded-full font-medium transition-all duration-200 block text-center ${
                    index === 1
      ...
      <section className="py-20 bg-slate-900">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-400 mb-8">Join hundreds of Malaysian businesses already using our AI-powered solutions</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/contact"
            ...
            <Link
              to="/info"
              className="border border-blue-500 text-blue-400 px-8 py-4 rounded-full text-lg font-medium hover:bg-blue-500 hover:text-white transition-all duration-200"
            >
              Download Tax Guide
            </Link>
          </div>
