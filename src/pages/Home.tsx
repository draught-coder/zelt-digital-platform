    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="pt-20 pb-20 relative overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-slate-900 via-blue-900 to-black">
          ...
          <div className="absolute top-20 left-10 w-40 h-40 border-2 border-blue-400 rounded-full opacity-30 animate-pulse shadow-lg shadow-blue-500/50"></div>
          <div className="absolute top-40 right-20 w-24 h-24 bg-gradient-to-r from-purple-500 to-blue-500 rounded-lg rotate-45 opacity-40 animate-spin shadow-2xl" style={{ animationDuration: '20s' }}></div>
          <div className="absolute bottom-20 left-1/4 w-20 h-20 border-4 border-purple-400 rotate-12 opacity-35 animate-bounce shadow-lg shadow-purple-500/30"></div>
          <div className="absolute top-1/3 right-1/3 w-32 h-32 border-2 border-cyan-300 rounded-full opacity-25 animate-pulse shadow-xl shadow-cyan-400/40"></div>
          
          {/* Dynamic light beams */}
          <div className="absolute top-0 left-1/4 w-px h-full bg-gradient-to-b from-transparent via-blue-400 to-transparent opacity-40 animate-pulse"></div>
          ...
          <div className="absolute top-0 left-3/4 w-px h-full bg-gradient-to-b from-transparent via-cyan-400 to-transparent opacity-35 animate-pulse" style={{ animationDelay: '2s' }}></div>
